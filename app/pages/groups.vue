...
xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
        ...
        <button
v-if="canCreateGroup" @click="openCreateModal"
...
xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
        ...
        <input
v-model="search" placeholder="Buscar grupos..."
...
xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none"
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
      <div
v-for="group in filteredGroups" :key="group.groupid"
...
xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none"
            ...
            <div class="flex items-center gap-1 opacity-100 sm:opacity-0 group-hover:opacity-100 transition-opacity">
              <button
v-if="canCreateGroup" @click="editGroup(group)"
      ...
      <div
        ...
        <form @submit.prevent="handleCreate" class="p-6 space-y-4">
          <div>
            ...
            <input
v-model="form.groupid" placeholder="Ej. dev-team" required
          ...
          <div>
            ...
            <textarea
v-model="form.comment" rows="3" placeholder="Descripción del grupo..."
...
interface Group { groupid: string; comment?: string }
...
// Edit
const editGroup = (g: Group) => { editing.value = { groupid: g.groupid, comment: g.comment || '' } }
